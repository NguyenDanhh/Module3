...
insert into position_employee(name_position)
value ('Quản lý '),
		('Nhân Viên');
        
insert into qualification_employee(name_qualification)
value('Trung Cấp'),
		('Cao Đẳng '),
		('Đại Học '),
		('Sau Đại Học');
        
insert into partscode_employee(name_partscode)
value('Sale-Marketing'),
		('Hành chính '),
		('Phục vụ'),
		('Quản lý');
        
insert into employee (name_employee,date_of_birth,idcard,salary,phone,email,address,id_position,id_qualification,id_partscode)
...
insert into rental_type_service(name_rental_type)
value('year'),
		('month'),
		('day'),
		('hour');
...
insert into service_furama(name_service, usable_area , rental_cost , number_person , 
			room_standards,description_facility,pool_area,floor,id_rental_type,id_type_service)
...
insert into accompanying_services(name_service,price,unit,condition_service)
...
insert into contract(date_start_contract,date_end_contract,deposit,id_employee,id_customer,id_service)
...
insert into contract_details(amount,id_contract,id_service)
value	(5,2,4),
		(8,2,5),
		(15,2,6),
		(1,3,1),
